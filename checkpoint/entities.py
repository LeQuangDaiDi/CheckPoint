...
class AttackProjectile:
    ...
    def draw(self, surface: pygame.Surface) -> None:
        ...
        tip = self.position + direction * (self.radius + 4)
        back = self.position - direction * self.radius
        pygame.draw.polygon(surface, color, [tip, back + side * self.radius, back - side * self.radius])
        ...
        tail = self.position - direction * 18
...
class DefenseProjectile:
    ...
    def draw(self, surface: pygame.Surface) -> None:
        ...
        pygame.draw.circle(surface, (220, 245, 255), self.position, self.radius + 2, 1)
